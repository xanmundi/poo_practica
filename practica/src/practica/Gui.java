...
public class Gui {
	...
	private void initialize() {
					...
					.addGroup(gl_Clientes.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_Clientes.createSequentialGroup()
							...
							.addGroup(gl_Clientes.createParallelGroup(Alignment.TRAILING)
								.addComponent(panel_CliAdd, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(panel_CliListado, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 270, GroupLayout.PREFERRED_SIZE))))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(panel_CliVehCli, GroupLayout.PREFERRED_SIZE, 145, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		);
		...
		ListadoPersonas lp= new ListadoPersonas();
		listaClientes.setModel(lp.getModelo());
		//listaClientes.setModel(new AbstractListModel() {
			//String[] values = new String[] {"elemento1"};
		...
		JButton btnEditar = new JButton("Editar");
		btnEditar.setBounds(179, 232, 219, 23);
		panel_CliListado.add(btnEditar);
		...
		JButton btnEliminarSeleccionado = new JButton("Eliminar Seleccionado");
		btnEliminarSeleccionado.setBounds(20, 235, 133, 20);
		panel_CliListado.add(btnEliminarSeleccionado);
		...
		btnEliminarSeleccionado.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
		        //if(listaClientes.isSelectionEmpty()){
		            //JOptionPane.showInputDialog(this,"Debe selecionar una persona de la lista");
		            //System.out.println("selecciona persona");
		        //}else{
		            //modelo.removeElementAt(listaClientes.getSelectedIndex());
		        	//modelo.addElement("Mierda");
		            modelo.remove(listaClientes.getSelectedIndex());
		            listaClientes.setModel(modelo);
		            //ListadoPersonas lp= new ListadoPersonas();
		            //lp.borraRegistro(listaClientes.getSelectedIndex());
		            //limpiarFormulario();
		            //System.out.println("valor: "+listaClientes.getSelectedIndex());
		       // }
			
			}
			@Override
			public void mouseEntered(MouseEvent arg0) {
				System.out.println("raton sobre boton eliminar");
			}
		});
		Clientes.setLayout(gl_Clientes);
